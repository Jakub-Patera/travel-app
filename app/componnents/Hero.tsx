  ...
  return (
    <>
      <section className="max-container padding-container flex  flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 md:flex-row  sm:items-center ">
            ...
            >
              <h1
                dangerouslySetInnerHTML={{
                  __html: TRIP_DESCRIPTION[currentTripIndex].title,
                }}
              ...
              <motion.p
                ...
                className="regular-16 text-gray-30 lg:maw-w-[520px] mt-6 lg:mr-32"
              >
        ...
        <div className="realtive flex flex-1 items-start right-20 z-20 -left-24 ">

...
const Slider = () => {
  return (
    <section className="flex justify-center items-center my-0 md:my-32 m relative pb-32 z-10 h-auto flex-col-reverse ">
      <div className=" mt-8 md:absolute -bottom-[200px] right-56 w-auto md:-bottom-[80px] md:right-20 aspect-video h-[350px] bg-green-50/95 z-50 px-12 py-16 rounded-3xl  text-gray-10 space-y-8 sm:flex justify-center items-center flex-col sm:mt-8 ms:scale-50">
        <Image
          src="./quote.svg"
          height={150}
          width={150}
